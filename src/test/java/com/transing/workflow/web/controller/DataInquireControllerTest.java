...
public class DataInquireControllerTest extends AbstractSpringBaseControllerTest {
    ...
    public void testGetDataImportListFromShowData() throws Exception {
        String requestURI = "/dataInquire.json";
        MvcResult mvcResult = this.mockMvc.perform(
                MockMvcRequestBuilders.post(requestURI).param("testInLogin", "no").param("paramId","936").param("projectId","197")).andDo(print()).andExpect(status().isOk()).andReturn();
