 ...
 */
public class BarChartProcess extends ChartProcess {
    ...
    public Map<String, Object> conversionChart() {
        ...
        if(!Validate.isEmpty(mapList)){
            ...
            */
            ...
            returnMap.put(BarChartProcess.KEY_DATAARRAY,defaultJsonObject);

            returnMap.put(BarChartProcess.KEY_TABLEARRAY,tableArray);
